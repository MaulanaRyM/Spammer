...
class prankcall{
	...
	public function run(){
		while(true){
			echo "--> Mau Kirim Mode Banyak? (y/n) = ";
			$loop = $this->get();
			if($loop=="y" OR $loop=="n"){
				break;
			}else{
				echo "Jika banyak jawab (y) jika tidak jawab (n)\n";
				continue;
			}
		}
		if($loop=="y"){
...
echo $green."
 ____                           ____         _ _
/ ___| ____   _____  ________  / ___| _____ | | |
\___ \|  _ \ (  _  )|  _   _ \| |    (  _  )| | |
 ___) | |_) )| (_) || | | | | | |___ | (_) || | |
|____/|  __/ |_| |_||_| |_| |_|\____||_| |_||_|_|
      |_|                              \n".$blue.
"Spammer Grab";
echo $red."
################################################
